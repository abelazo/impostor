...
describe("TopicSelector", () => {
  ...
  it("renders topic options", () => {
    render(
      <TopicSelector topics={mockTopics} value="food" onChange={vi.fn()} />,
    );
  ...
  it("calls onChange when selection changes", async () => {
    ...
    render(
      <TopicSelector topics={mockTopics} value="food" onChange={onChange} />,
    );
  ...
  it("displays all available topics", () => {
    ...
    expect(
      screen.getByRole("option", { name: "Comida y bebida" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("option", { name: "Objetos de la vida diaria" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("option", { name: "Medios de transporte" }),
    ).toBeInTheDocument();
  });
